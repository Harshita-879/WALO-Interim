    ...
    return (
        <div className="bg-[#ffffff] h-screen flex flex-col items-center justify-center">
                ...
                <div className="bg-white flex flex-col bg-opacity-10 p-5 rounded-xl">
                    <div className="flex items-center justify-between mr-12">
                        ...
                        <Link href="/kyc/company/bankverification">
                            <button className="bg-[#6251A3] text-white font-bold rounded-xl p-4 m-4">Bank Verification</button>
                        </Link>
                        <Link href="/kyc/company/gst">
                            <button className="text-black font-bold rounded-xl p-4 m-4">GST Invoice</button>
                        </Link>
                    </div>
                    <div className="border-t-2 border-white"></div>
                    <div className="flex items-center justify-center mt-8">
                        <div className="flex flex-col items-start justify-start mr-12"> 
                            <label className="text-lg mx-4 font-bold">Enter your Bank Verification Number</label>
                            <input className="bg-[#BDB3DF] p-4 m-4 w-96 placeholder-gray-500" type="text" placeholder="Enter your Bank Verification Number here" />
            ...
            <div className='w-[90%]  flex flex-col justify-start items-center md:hidden'>
                ...
                <h1 className="text-xl font-light md:font-bold text-black m-2 w-full text-left">3. Bank Verification</h1>
                <input className="p-4 m-4 w-80 placeholder-gray-500 border border-[#6251A3]" type="text" placeholder="Bank Verification Number " />
                <Image src={upload} height={300} className='w-80' alt="upload" />
                <h4 className='text-[#6251A3] py-3'>Format: PDF, PNG, JPG</h4>
                    <Link href="/kyc/company/gst">
                        <button className="bg-[#6251A3] text-white font-bold rounded-xl p-4 m-4 w-48">CONTINUE</button>
                    </Link>
