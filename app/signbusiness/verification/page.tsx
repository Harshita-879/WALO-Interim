...
export default function VerifyLogin() {
  ...
  return (
    <div className="bg-[#6251A3] h-screen flex  items-center justify-center ">
      <div className="bg-white flex bg-opacity-10 p-12 rounded-xl shadow-2xl border-l-[1px] border-gray hidden md:flex">
      ...
      <div className="mx-auto my-auto text-white lg:hidden justify-center items-center">
        ...
        <button type="button" className="font-mplus text-sm bg-[#5AD192] py-2 px-6 ml-12 rounded text-white shadow-lg">
          CONTINUE
        </button>
      </div>
    </div>
...
//   return (
//     <div className="bg-[#6251A3] h-screen flex items-center justify-center">
//       <div className="bg-white flex bg-opacity-10 p-6 md:p-12 rounded-xl shadow-2xl border-l-[1px] border-gray w-full md:w-auto">
//         <div className="mx-auto my-auto text-white lg:hidden">
//           <p className="font-mplus text-2xl font-medium">Enter OTP</p>
